<template>
  <div class="flex h-screen w-screen bg-white shadow-2xl">
    <!-- form  left side-->
    <div
    ...
    >
      <div class="flex w-92 flex-col items-center justify-center md:w-140">
        ...
        <!-- username -->
        <div
          class="mb-1 flex w-78 flex-col sm:w-140 md:mb-2 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
        >
          <label
            for="username"
            class="w-78 text-left font-bold text-[#656565] sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
            >Username</label
          >
          <input
            id="username"
          ...
          <p
            ...
            class="mt-1 mb-1 w-78 text-left text-red-400 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
          >
            {{ errors.username }}
          </p>
        </div>
        ...
        >
          ...
          >
          <label
            class="input w-78 border-[#DCDCDC] bg-white sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
          >
            <input
              id="password"
        ...
        <!-- Remember me -->
        <div
          class="mt-2 mb-3 flex w-78 items-start sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
        >
        ...
        <p
          v-if="serverError"
          class="mt-3 w-78 text-center text-red-400 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
        >
          {{ serverError }}
        </p>
      </div>
