  ...
  <div class="flex h-[56rem] w-screen bg-white shadow-2xl md:h-[43.45rem]">
    ...
    >
      <div class="flex w-92 flex-col items-center justify-center md:w-140">
        <h1
          class="text-center text-3xl font-bold text-[#763A26] sm:text-4xl md:text-3xl"
        >
          Sign Up
        </h1>
        ...
        <!-- username -->
        <div
          class="mb-2 flex w-94 flex-col sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
        >
          <label
            for="username"
            class="w-94 text-left font-bold text-[#656565] sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
            >Username</label
          >
          <input
            id="username"
        ...
        >
          ...
          >
          <label
            class="input w-94 border-[#DCDCDC] bg-white sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
          >
            <input
              id="password"
        ...
        <div
          class="mb-4 w-94 border-t-2 border-[#EFEFEF] sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
        ></div>
        <button
          @click="validateForm"
          class="btn w-94 border-0 bg-[#763A26] text-xl sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
        >
          Sign Up
        </button>
        <div class="mt-3 flex flex-row items-center gap-1 text-xl md:hidden">
          <p class="text-gray-500">Already have an account?</p>
          <router-link to="/login" class="text-[#763A26] underline"
            >Login!</router-link
          >
        </div>
        <p
          v-if="serverError"
          class="mt-3 w-94 text-center text-red-400 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
        >
          {{ serverError }}
        </p>
      </div>
