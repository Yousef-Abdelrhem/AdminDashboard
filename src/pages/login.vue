  ...
  <div class="bg-white w-screen h-[56rem] md:h-[43.45rem] flex shadow-2xl">
    ...
    <div class="flex justify-center items-center h-full flex-grow-1 md:w-[50%] lg:w-[20rem] xl:w-[35rem]">
      <div class="w-92 md:w-140 flex justify-center items-center flex-col">
        <h1 class="text-[#763A26] text-3xl sm:text-4xl md:text-3xl font-bold text-center">Login</h1>
        <p class="text-gray-500 text-center mb-5 text-lg sm:text-xl">Please enter your email and password</p>
        <!-- email -->
        <div class="flex flex-col mb-2 w-94 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160">
          <label for="email" class="text-[#656565] font-bold text-left w-94 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160">E-mail</label>
          ...
          <p v-if="errors.email" class="text-red-400 w-94 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160 text-left mb-1">{{ errors.email }}</p>
        </div>
        <!-- password -->
        <div class="flex flex-col mb-2 w-94 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160">
          <label for="password" class="text-[#656565] font-bold text-left w-94 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160">Password</label>
          <label class="input bg-white border-[#DCDCDC] w-94 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160">
            ...
            <svg v-else @click="togglePasswordVisibility" xmlns="http://www.w3.org/2000/svg" fill="none"
              viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6.5 sm:size-6 md:size-6 text-[#7C7C7C] cursor-pointer">
          ...
          <p v-if="errors.password" class="text-red-400 w-94 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160 text-left mb-1">{{ errors.password }}</p>
        </div>
        ...
        <button @click="validateForm" class="btn bg-[#763A26] text-xl border-0 w-94 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160">Login</button>
        ...
        <p v-if="serverError" class="text-red-400 w-94 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160 text-center mt-3">{{ serverError }}</p>
      </div>
    </div>
    <!-- image right side -->
    <div
