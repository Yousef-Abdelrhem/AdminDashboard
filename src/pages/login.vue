  ...
  <div class="flex h-screen w-screen bg-white shadow-2xl">
    ...
    >
      <div class="flex w-92 flex-col items-center justify-center md:w-140">
        ...
        <!-- email -->
        <div
          class="mb-2 flex w-78 flex-col sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
        >
          <label
            for="email"
          ...
          <p
            v-if="errors.email"
            class="mb-1 w-78 text-left text-red-400 sm:w-140 md:w-110 lg:w-120 xl:w-150 2xl:w-160"
          >
            {{ errors.email }}
          </p>
        </div>
