            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <form @submit.prevent="submitProduct"
                    ...
                    <fieldset class="fieldset flex">
                        ...
                        <input v-model="name" type="text" class="input w-full focus-within:border-0"  placeholder="bags"/>
                    </fieldset>
                    ...
                    <fieldset class="fieldset flex">
                        ...
                        <input v-model="price" type="text" class="input w-full focus-within:border-0"
                            placeholder="$200" />
                    </fieldset>
                    ...
                    <fieldset class="fieldset flex">
                        ...
                        <input v-model="inStock" type="text" class="input w-full focus-within:border-0"
                            placeholder="200" />
                    </fieldset>
