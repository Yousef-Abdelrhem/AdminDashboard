  ...
  <div class="card bg-base-100 card-sm border-main h-33 w-82 border shadow-sm">
    <div class="card-body">
        ...
        <div class="flex justify-between">
          ...
          <svg width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
              ...
              stroke="#FE9423" stroke-width="1.125" stroke-linecap="round" stroke-linejoin="round" />
            <path
      ...
      <div class="flex items-center justify-between gap-1">
        <p class="text-[1.3rem] font-bold">${{ data.totalRevenue?.toLocaleString() }}</p>
        <div class="flex items-center justify-center">
          <svg width="25" height="13" viewBox="0 0 25 13" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              ...
              stroke="#1CB808" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          </svg>
