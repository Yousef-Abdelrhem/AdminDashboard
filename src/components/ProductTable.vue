<template>
    <div class="rounded-lg border border-gray-200">
            ...
            <tbody>
                <tr v-for="(product, index) in paginatedProducts" :key="product.productId"
                    ...
                    <td class="py-3 px-2 flex justify-center items-center">
                        <img class="rounded-full border-3 border-main-900" :src="product.productImage[0]" width="40"
                            height="40" />
                    </td>
                    <td class="text-center py-3 px-2">{{ product.productName }}</td>
                    <td class="text-center py-3 px-2">{{ product.description }}</td>
                        ...
                        <div v-if="openMenuIndex === index"
                            ...
                            <ul class="text-sm">
                                ...
                                <li @click="handleAction('view', product)" :class="[
                                    ...
                                    <p class="hidden sm:flex">View Details</p>
                                </li>
                                <hr class="w-30 ml-2 text-gray-400">
        ...
        <div class="pagination my-4 flex justify-center gap-1 text-gray-600">
            <button class="w-9 h-9 flex justify-center items-center rounded border-2 border-[#F1D6B7]" @click="prevPage"
            ...
            <button class="w-9 h-9 flex justify-center items-center rounded border-2 border-[#F1D6B7]" @click="nextPage"
