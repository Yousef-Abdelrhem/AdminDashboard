    ...
    <div v-if="paginatedProducts && paginatedProducts.length > 0">
      <table class="w-full">
        <thead>
          <tr class="text-gray-800">
            ...
            <th class="px-4 py-5 text-sm md:text-lg">Price</th>
            <th class="px-4 py-5 text-sm md:text-lg">In Stock</th>
            <th class="px-4 py-5 text-sm md:text-lg">Category</th>
          ...
          >
            <td class="text-md px-4 py-3 text-center">
              <input
                ...
                @change="handleCheckboxChange(product.productId)"
            ...
            <td class="px-2 py-3 text-center">{{ product.name }}</td>
              ...
              >
                <ul class="text-sm">
                  <li
                    ...
                    :class="[
                      'hover:text-main-900 flex cursor-pointer gap-3 px-2 py-2 text-gray-500 hover:rounded-t-lg',
                      activeAction === 'edit' &&
      ...
      <div class="pagination my-4 flex justify-center gap-1 text-gray-600">
        ...
        <span
          ...
          :key="index"
          class="flex h-9 w-9 cursor-pointer items-center justify-center rounded border-2 border-[#F1D6B7]"
          :class="{
            'text-main-900 bg-[#F1D6B7] font-bold': props.currentPage === page,
          }"
