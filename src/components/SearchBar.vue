...
<template>
  <label class="input h-14 w-full items-center rounded-lg focus-within:outline-none">
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
      class="h-[1.5rem] opacity-100">
      <path
    ...
    <input type="search" :value="modelValue"  @input="emit('update:modelValue', $event.target.value)" required placeholder="Search" class="" />
  </label>
</template>
