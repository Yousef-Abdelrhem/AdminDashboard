            ...
            <div class="space-y-4 mt-6">
                ...
                <div>
                    <label class="flex items-center space-x-2 text-main-900 font-semibold">
                        ...
                        <span :class="filters.nameEnabled ? 'text-main-900' : 'text-gray-500'">Enter Customer Name</span>
                    </label>
                ...
                <div>
                    <label class="flex items-center space-x-2 text-main-900 font-semibold">
                        <input type="checkbox" class="accent-main-900" v-model="filters.numOrderEnabled" />
                        <span :class="filters.numOrderEnabled ? 'text-main-900' : 'text-gray-500'">Enter Number of Orders </span>
                    </label>
                    <input type="number" class="w-full border border-gray-400 h-10 rounded-md px-3 mt-1"
                        v-model="filters.numOrder" :disabled="!filters.numOrderEnabled" />
                </div>
                <div>
                    <label class="flex items-center space-x-2 text-main-900 font-semibold">
                        <input type="checkbox" class="accent-main-900" v-model="filters.priceEnabled" />
                        <span :class="filters.priceEnabled ? 'text-main-900' : 'text-gray-500'">Choose Total Price of orders </span>
                        <span class="text-sm text-main-900 font-bold ransition-colors duration-300"
                ...
                <div>
                    <label class="flex items-center space-x-2 text-main-900 font-semibold">
                        <input type="checkbox" class="accent-main-900" v-model="filters.tagEnabled" />
                        <span :class="filters.tagEnabled ? 'text-main-900' : 'text-gray-500'">Choose  Customer Tag</span>
                    </label>
                    <select class="w-full border border-gray-400 hover:accent-amber-100 h-10 rounded-md px-3 mt-1"
                        v-model="filters.tag" :disabled="!filters.tagEnabled">
